...
- Hvis du har glemt passordet, men er logget på med bufret legitimasjon, legger du til eller endrer sikkerhetsinformasjonen på Min konto [>](https://mysignins.microsoft.com/security-info)Sikkerhetsinformasjon , og deretter tilbakestiller du passordet ved hjelp [av SSPR](https://passwordreset.microsoftonline.com/). (De fleste kontoer krever en alternativ e-post og et telefonnummer for å fullføre tilbakestillingen).
