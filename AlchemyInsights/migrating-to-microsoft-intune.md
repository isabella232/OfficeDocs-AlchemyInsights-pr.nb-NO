...
Hvis du vil ha mer spesifikk veiledning om overføring fra System Center Configuration Manager (og SCCM Hybrid) til Intune, kan du bruke [dokumentasjonen](https://docs.microsoft.com/sccm/mdm/deploy-use/migrate-hybridmdm-to-intunesa)for hybrid overføring på nytt. 