...
4. Velg et **Til-adresse-** **eller Regressed-element** fra listen på Fanen **Forbedringshandlinger.** En ny side åpnes og gir en fullstendig beskrivelse og en **Behandle-knapp** for å løse problemet.
    ...
    **Obs!** Du får poeng for å konfigurere anbefalte sikkerhetsfunksjoner, men husk at noen handlinger er merket som **[Ikke scoret]**. Dette betyr at selv om du implementerer denne forbedringshandlingen, får du ikke poeng for poengsummen din. Ellers *kan det ta opptil 24 timer* før poengsummen oppdateres.
