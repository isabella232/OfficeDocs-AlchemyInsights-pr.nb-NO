...
Hvis en bruker blir bedt om å **logge på å konfigurere Office**, må de imidlertid logge på med sitt arbeid eller skolen-konto som bør allerede ha en [tilordnet Office-lisens](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users).
