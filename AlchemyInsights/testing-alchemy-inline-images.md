---
title: Testing av alkymi-inline-bilder
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505064"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="4e6eb-102">Få tilgang til Domener-siden</span><span class="sxs-lookup"><span data-stu-id="4e6eb-102">Access the Domains Page</span></span>

<span data-ttu-id="4e6eb-103">For å få tilgang til domenesiden, bare klikk på dette ikonet nedenfor:</span><span class="sxs-lookup"><span data-stu-id="4e6eb-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="4e6eb-104">Deretter kan du legge til, endre eller fjerne domenet.</span><span class="sxs-lookup"><span data-stu-id="4e6eb-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="4e6eb-105">Hvis du vil ha mer informasjon, kan du se vanlige spørsmål om [domener.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="4e6eb-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
