...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="867db-102">Åpne domener-siden</span><span class="sxs-lookup"><span data-stu-id="867db-102">Access the Domains Page</span></span>

<span data-ttu-id="867db-103">Å adgang det domenen side, rettferdig falle i staver denne ikon neden:</span><span class="sxs-lookup"><span data-stu-id="867db-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="867db-104">Deretter kan du legge til, endre eller fjerne domenet.</span><span class="sxs-lookup"><span data-stu-id="867db-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="867db-105">Hvis du vil ha mer informasjon, kan du se [vanlige spørsmål om domener.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="867db-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
