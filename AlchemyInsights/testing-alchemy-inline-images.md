...
---
# <a name="access-the-domains-page"></a>Åpne domener-siden

Å adgang det domenen side, rettferdig falle i staver denne ikon neden:
...
Deretter kan du legge til, endre eller fjerne domenet.
Hvis du vil ha mer informasjon, kan du se [vanlige spørsmål om domener.](https://docs.microsoft.com/office365/admin/setup/domains-faq)
