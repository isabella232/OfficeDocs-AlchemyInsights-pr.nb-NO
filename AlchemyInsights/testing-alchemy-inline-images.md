---
title: Testing av alkymi innebygde bilder
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="1221d-102">Få tilgang til Domener-siden</span><span class="sxs-lookup"><span data-stu-id="1221d-102">Access the Domains Page</span></span>

<span data-ttu-id="1221d-103">For å få tilgang til domenesiden, bare klikk på dette ikonet nedenfor:</span><span class="sxs-lookup"><span data-stu-id="1221d-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="1221d-104">Deretter kan du legge til, endre eller fjerne domenet.</span><span class="sxs-lookup"><span data-stu-id="1221d-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="1221d-105">Hvis du vil ha mer informasjon, kan du se [Vanlige spørsmål om domener.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="1221d-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
