...
2. Velg abonnementet du vil aktivere på nytt. Velg Aktiver på **nytt**i Fakturering-delen.
    ...
    Hvis du ikke **ser Aktiver på nytt** som en tilgjengelig handling, [kan du ringe kundestøtte](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products) for å aktivere abonnementet på nytt.
