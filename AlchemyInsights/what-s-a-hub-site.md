...
ms.locfileid: "29911493"
---
# <a name="whats-a-hub-site"></a><span data-ttu-id="a1a85-102">Hva er et hubområde?</span><span class="sxs-lookup"><span data-stu-id="a1a85-102">What's a hub site?</span></span>

<span data-ttu-id="a1a85-p101">Et hubområde hjelper deg med å ordne områder og gi dem en felles navigering og merking. Global eller SharePoint-administratorer skal kunne opprette hub områder, og angi hvilke brukere som kan knytte sine områder til hubområdet. For mer informasjon, kan du se [SharePoint-områder for huben nytt i Office 365](https://go.microsoft.com/fwlink/?linkid=869388).</span><span class="sxs-lookup"><span data-stu-id="a1a85-p101">A hub site helps you organize sites and give them a common navigation and branding. Global or SharePoint admins will be able to create hub sites and specify which users can associate their sites with the hub site. For more info, see [SharePoint hub sites new in Office 365](https://go.microsoft.com/fwlink/?linkid=869388).</span></span>
