...
- Hvis du vil slette et område, kan du se [slette et område](https://docs.microsoft.com/sharepoint/delete-site-collection#permanently-delete-a-site). Dette trinnet vil være nødvendig hvis du planlegger å bruke URL-adressen på nytt. 
