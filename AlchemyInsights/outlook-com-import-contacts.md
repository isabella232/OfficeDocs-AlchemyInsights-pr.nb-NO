...
Før du importerer kontakter til Outlook.com, må du eksportere dem fra den andre e-postleverandøren som en. CSV-fil. Følg deretter instruksjonene nedenfor.
...
.
2. Velg **Behandle** \> **Importer kontakter**øverst på siden.
3. Velg **Bla gjennom**, Naviger til mappen der du lagret de eksporterte kontaktene, og velg **Åpne**.
