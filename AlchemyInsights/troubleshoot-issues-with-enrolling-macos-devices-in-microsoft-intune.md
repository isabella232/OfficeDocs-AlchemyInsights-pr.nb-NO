...
ms.locfileid: "29482224"
---
# <a name="troubleshoot-issues-with-enrolling-macos-devices-in-microsoft-intune"></a>Feilsøke problemer med å melde deg inn macOS enheter i Microsoft Intune
...
3. [Lær hvordan du kan registrere macOS enheter i Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Sjekk ut sluttbrukere veiledning til å registrere macOS enheten i Microsoft Intune](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
