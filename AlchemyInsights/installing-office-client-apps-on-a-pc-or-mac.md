...
**Merk**: [Office-aktiveringsrapporten](https://docs.microsoft.com/microsoft-365/admin/activity-reports/microsoft-office-activations?view=o365-worldwide) gir deg oversikt over hvilke brukere som har installert og aktivert Office-appene sine på minst én enhet.
