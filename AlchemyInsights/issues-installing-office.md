...
- Rydd opp eventuelle spor etter Office, og installer på nytt ved hjelp av Assistent for støtte og gjenoppretting (SaRA). 
    ...
    - Bruk SaRA til å [installere Office på nytt](http://aka.ms/sara-officeinstall). **Obs**! Bruk [Installere Visio](https://aka.ms/SaRA-VisioSetupScenario) eller [Installere Project](https://aka.ms/SaRA-ProjectSetupScenario) for å konfigurere Visio eller Project med SaRA.  
